package com.mobilerecharge.mounika.utils;
...
public class MyConstant {
    ...
    public static final String PLANS_ADD = "/add";
    public static final String PLANS_GET = "/get";
    ...
    //SWAGGER
    public static final String SWAGGER_INFO_TITLE ="Netfi";
    public static final String SWAGGER_INFO_DESCRIPTION ="Seamless Recharge for ";
    public static final String SWAGGER_INFO_VERSION ="1.0.0";
    public static final String SWAGGER_INFO_CONTACT_NAME ="Mounika Sri";
    public static final String SWAGGER_INFO_CONTACT_EMAIL ="727721eucs081@skcet.ac.in";
